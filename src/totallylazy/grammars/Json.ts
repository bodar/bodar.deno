...
import {between, literal, next, separatedBy, surroundedBy, then, whitespace} from "../parsers/parsers.ts";
...
export class Json {
    ...
    static string: Parser<string, string> = parser(this.characters, or(this.escaped), many(),
